...
__DEFINE__(1687425908377, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1687425908378,"./event-store":1687425908379}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1687425908378, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1687425908379, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1687425908378,"./utils":1687425908380}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1687425908380, function(require, module, exports) {
...
return __REQUIRE__(1687425908377);
})()
